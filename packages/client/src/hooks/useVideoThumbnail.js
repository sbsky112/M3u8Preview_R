...
/** 从 localStorage 读取缓存 */
function readLocalCache(mediaId) {
    try {
...
/** 写入 localStorage 缓存 */
function writeLocalCache(mediaId, dataUrl) {
    try {
 ...
 */
async function extractFrame(m3u8Url, abortSignal) {
    return new Promise((resolve) => {
...
// 启动时清理过期缓存
purgeExpiredThumbs();
export function useVideoThumbnail(mediaId, m3u8Url, posterUrl) {
